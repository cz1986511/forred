    ...
    str += '<div class="weui-cell weui-cell_swiped">'
      str += '<div class="weui-cell__bd">'
        str += '<div class="weui-cell">'
         str += '<div class="weui-cell__hd lucky-bag-pic to-luckybag-detail" data-fdid="'+data[i].fdId+'"><img src="../../image/yfd1.png" alt="" ></div>'
          str += '<div class="weui-cell__bd" data-fdid="'+data[i].fdId+'">'
            str += '<p class="lucky-bag-name"><span class="to-luckybag-detail" data-fdid="'+data[i].fdId+'">'+data[i].fdName+'</span></p>'
          str += '</div>'
